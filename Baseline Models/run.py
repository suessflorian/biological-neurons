...
load_name = 'CIFAR-10-LeNet5-50-epochs' # set to None if loading not required
save_name = 'CIFAR-10-LeNet5-50-epochs' # set to None if saving not required
train = True
...
accuracy = test_model(model, loader=test_loader, device=device)
